...
fun fprops fm = 
    case fm of 
        Pred _ => HOLset.empty String.compare
      |fVar(P,[],[]) => HOLset.add(HOLset.empty String.compare,P)
      |fVar(P,h::t,_) => HOLset.empty String.compare
      | Conn(co,fl) => List.foldr (HOLset.union) (HOLset.empty String.compare) (List.map fprops fl)
      |Quant(q,n,s,b) => fprops b

fun flprops fl = List.foldr (fn (f,ps) => HOLset.union (fprops f,ps)) (HOLset.empty String.compare) fl
