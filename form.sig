...
val mk_fvar: string -> (string * sort) list -> term list -> form
...
val dest_fvar: form -> string * (string * sort) list * term list
...
val fVar_prpl: (string * sort list, form) Binarymap.dict -> form -> form
val no_fVar: form -> bool 

val fVars: form -> (string * sort list) set
val fVarsl: form list -> (string * sort list) set
val fabs: (string * sort) -> int -> form -> form
val fabsl: (string * sort) list -> int -> form -> form
val delete_psym: string -> unit
val mk_fd:
   (string * (string * sort) list * form) list ->
     (string * sort list, form) Binarymap.dict
val fprops: form -> string set
val flprops: form list -> string set
end
