...
struct
  ...
  fun op v2twbmap_def _ = () val op v2twbmap_def = TDB.find "v2twbmap_def"
  ...
  fun op fabsl_def _ = () val op fabsl_def = TDB.find "fabsl_def"
  fun op wfabsap0_wft _ = () val op wfabsap0_wft = TDB.find "wfabsap0_wft"
  fun op LENGTH_specslwtl _ = ()
  val op LENGTH_specslwtl = TDB.find "LENGTH_specslwtl"
  fun op FAPPLY_v2twbmap _ = ()
  val op FAPPLY_v2twbmap = TDB.find "FAPPLY_v2twbmap"
  ...
  fun op FDOM_v2twbmap _ = ()
  val op FDOM_v2twbmap = TDB.find "FDOM_v2twbmap"
  fun op tprpl_wvar _ = () val op tprpl_wvar = TDB.find "tprpl_wvar"
  ...
  fun op tfv_trpl_SUBSET1 _ = ()
  val op tfv_trpl_SUBSET1 = TDB.find "tfv_trpl_SUBSET1"
  fun op tfv_tprpl_SUBSET _ = ()
  val op tfv_tprpl_SUBSET = TDB.find "tfv_tprpl_SUBSET"
  fun op wfabsap_wfabsap0 _ = ()
  val op wfabsap_wfabsap0 = TDB.find "wfabsap_wfabsap0"
