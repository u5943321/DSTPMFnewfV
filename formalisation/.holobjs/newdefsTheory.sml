...
struct
  ...
  fun op freshnl_def _ = () val op freshnl_def = TDB.find "freshnl_def"
  ...
  fun op nameleast_def _ = ()
  val op nameleast_def = TDB.find "nameleast_def"
  fun op freshnl_compute0 _ = ()
  val op freshnl_compute0 = TDB.find "freshnl_compute0"
  ...
  fun op wfabsap_specslwtl _ = ()
  val op wfabsap_specslwtl = TDB.find "wfabsap_specslwtl"
