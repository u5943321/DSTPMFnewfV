structure syntaxTheory :> syntaxTheory =
struct
  
  val _ = if !Globals.print_thy_loads
    then TextIO.print "Loading syntaxTheory ... "
    else ()
  ...
  structure TDB = struct
    val thydata = 
      TheoryReader.load_thydata "syntax"
        (holpathdb.subst_pathvars "/Users/yimingxu/Documents/GitHub/DSTPMF/formalisation/syntaxTheory.dat")
  ...
  fun op treplace_def_UNION_primitive _ = ()
  val op treplace_def_UNION_primitive = TDB.find
    "treplace_def_UNION_primitive"
  fun op treplace_def_UNION_extract1 _ = ()
  val op treplace_def_UNION_extract1 = TDB.find
    "treplace_def_UNION_extract1"
  fun op treplace_def_UNION_extract0 _ = ()
  val op treplace_def_UNION_extract0 = TDB.find
    "treplace_def_UNION_extract0"
  ...
  fun op treplace_ind _ = () val op treplace_ind = TDB.find "treplace_ind"
  fun op treplace_def _ = () val op treplace_def = TDB.find "treplace_def"
  ...
  fun op treplace_trpl _ = ()
  val op treplace_trpl = TDB.find "treplace_trpl"
  ...
  fun op treplace_tsstt _ = ()
  val op treplace_tsstt = TDB.find "treplace_tsstt"
  ...
  fun op treplace_tsubst _ = ()
  val op treplace_tsubst = TDB.find "treplace_tsubst"
  ...
  fun op treplace_id _ = () val op treplace_id = TDB.find "treplace_id"
  fun op sinst_sreplace _ = ()
  val op sinst_sreplace = TDB.find "sinst_sreplace"
...
val _ = Theory.load_complete "syntax"

val syntax_grammars = valOf (Parse.grammarDB {thyname = "syntax"})
end
