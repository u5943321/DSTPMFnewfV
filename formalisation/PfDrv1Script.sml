...
Proof
 ...
 >- (Cases_on ‘th’ >> Cases_on ‘r’ >>
    gs[fVinsth_def] >> first_x_assum irule >> metis_tac[])
 >- (Cases_on ‘th’ >> Cases_on ‘r’ >>
...
>- (Cases_on ‘th’ >> Cases_on ‘r’ >>
   ...
   >- (qspecl_then [‘f1’,‘fσ’] assume_tac
      ...
      suffices_by
        (rw[] >>
        ‘ffv f1 ∪ ffv (fVinst fσ f1) ⊆ Γ’
         suffices_by
          (gs[SUBSET_DEF] >> metis_tac[]) >>
        pop_assum SUBST_ALL_TAC >>
        gs[] >> rw[] >>
        gs[ofFMAP_FDOM,cont_def,thfVars_def,Uof_UNION,Uof_Sing]
         >> 
    ...
    ‘ffv x ∪ ffv (fVinst fσ x) ⊆ Γ’
        ...
        >- (gs[SUBSET_DEF,Uof_SUBSET] >>
           metis_tac[]) >> 
        gs[ofFMAP_FDOM,cont_def,thfVars_def,
           Uof_UNION,Uof_Sing] >>
