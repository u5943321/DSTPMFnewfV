...
sig
  ...
  (*  Definitions  *)
    ...
    val tpsubtm_def : thm
    val treplace_def_UNION_extract0 : thm
    val treplace_def_UNION_extract1 : thm
    val treplace_def_UNION_primitive : thm
  ...
  (*  Theorems  *)
    ...
    val treplace_def : thm
    val treplace_id : thm
    val treplace_ind : thm
    val treplace_trpl : thm
    val treplace_tsstt : thm
    val treplace_tsubst : thm
    val trpl_def : thm
  ...
  val syntax_grammars : type_grammar.grammar * term_grammar.grammar
(*
   [finite_map] Parent theory of "syntax"
   
   [finite_set] Parent theory of "syntax"
   
   [string] Parent theory of "syntax"
                 ...
                 ∀ $var$('term') $var$('sort')
                   ...
                   (∀a0'.
                      ...
                      (∃a0 a1 a2.
                         ...
                         $var$('@temp @ind_typesyntax0list') a2) ∨
                      (∃a. a0' =
                           (λa.
                      ...
                      (∃a0 a1.
                         ...
                         (λa0 a1.
                              ind_type$CONSTR (SUC (SUC (SUC 0))) (a0,ARB)
                                (ind_type$FCONS a1 (λn. ind_type$BOTTOM)))
                           a0 a1 ∧ $var$('@temp @ind_typesyntax0list') a1) ⇒
                      $var$('sort') a1') ∧
                   (∀a2'.
                      a2' =
                         ...
                         (λa0 a1.
                              ind_type$CONSTR
                                ...
                                (ind_type$FCONS a0
                                   (ind_type$FCONS a1 (λn. ind_type$BOTTOM))))
                           a0 a1 ∧ $var$('term') a0 ∧
                         $var$('@temp @ind_typesyntax0list') a1) ⇒
                      $var$('@temp @ind_typesyntax0list') a2') ⇒
                   $var$('sort') a1') rep
   ...
   [treplace_def_UNION_extract0]  Definition
      
      ⊢ ∀x x0 x1.
          treplace x x0 x1 = OUTL (treplace_def_UNION (INL (x,x0,x1)))
   
   [treplace_def_UNION_extract1]  Definition
      
      ⊢ ∀x x0 x1.
          sreplace x x0 x1 = OUTR (treplace_def_UNION (INR (x,x0,x1)))
   
   [treplace_def_UNION_primitive]  Definition
      
      ⊢ treplace_def_UNION =
        WFREC
          (@R. WF R ∧
               (∀n s new i. R (INR (i,new,s)) (INL (i,new,Var n s))) ∧
          ...
          (λtreplace_def_UNION a'.
               case a' of
                 INL (i,new,Var n s) =>
                   I
                     (INL
                        (Var n (OUTR (treplace_def_UNION (INR (i,new,s))))))
               | INL (i,new,Fn f s' tl) =>
                 I
                   (INL
                      (Fn f (OUTR (treplace_def_UNION (INR (i,new,s'))))
                         (MAP
                            (λa. OUTL (treplace_def_UNION (INL (i,new,a))))
                            tl)))
               | INL (i,new,Bound j) =>
                   ...
                   (INR
                      (St n'
                         (MAP
                            (λa.
                                 OUTL
                                   (treplace_def_UNION (INL (i',new',a))))
                            tl'))))
   ...
   [sinst_sreplace]  Theorem
      
      ⊢ (∀tm i t σ.
           (∀n s. (n,s) ∈ tfv tm ⇒ sbounds s = ∅) ∧
           (∀v. v ∈ FDOM σ ⇒ tbounds (σ ' v) = ∅) ∧ tfv tm ⊆ FDOM σ ⇒
           tinst σ (treplace i t tm) = treplace i (tinst σ t) (tinst σ tm)) ∧
        ∀st i t σ.
          (∀n s. (n,s) ∈ sfv st ⇒ sbounds s = ∅) ∧
          (∀v. v ∈ FDOM σ ⇒ tbounds (σ ' v) = ∅) ∧ sfv st ⊆ FDOM σ ⇒
          sinst σ (sreplace i t st) = sreplace i (tinst σ t) (sinst σ st)
   ...
   [treplace_def]  Theorem
      
      ⊢ (∀new j i.
           treplace i new (Bound j) = if i = j then new else Bound j) ∧
        (∀s new n i. treplace i new (Var n s) = Var n (sreplace i new s)) ∧
        (∀tl s new i f.
           treplace i new (Fn f s tl) =
           Fn f (sreplace i new s) (MAP (λa. treplace i new a) tl)) ∧
        ∀tl new n i.
          sreplace i new (St n tl) = St n (MAP (λa. treplace i new a) tl)
   ...
   [treplace_ind]  Theorem
      
      ⊢ ∀P0 P1.
          (∀i new j. P0 i new (Bound j)) ∧
          (∀i new n s. P1 i new s ⇒ P0 i new (Var n s)) ∧
          (∀i new f s tl.
