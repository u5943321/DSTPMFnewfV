...
(form_goal
 “Disc(A) & 
 (!(a : fun(1, A)). ?!(b : fun(1, B)). R[a:1->A,b:1->B](a, b)) & 
 (∃g:2->B.
        ∃a1 b1. f = id(a1) & g = id(b1) & R[a:1->A,b:1->B](a1,b1)) ==>
 ?!(g : fun(2, B)).
               ?(a1 : fun(1, A))  (b1 : fun(1, B)).
                 f = id(a1) & g = id(b1) & R[a:1->A,b:1->B](a1, b1)”)

val CC5_Disc_uex_lemma = proved_th $
e0
(rpt strip_tac >> 
 irule1 CC5_Disc_uex_lemma0 >> arw[] >> 
 first_x_assum 
...
(rpt strip_tac >> 
 suffices_tac
 “?cf:A->B. ∀a:1->A b:1->B. R[a:1->A,b:1->B](a,b) ⇔ cf o a = b”
 >-- (strip_tac >> uex_tac >> qexists_tac ‘cf’ >> arw[] >>
      rpt strip_tac >> irule fun_ext_Disc >> arw[] >>
      pop_assum (assume_tac o GSYM) >> arw[]) >>
 assume_tac
 (CC5_uex 
 |> fVar_prpl_th (mk_fd [("R",List.map (dest_var o rastt)["f:2->A","g:2->B"],
    “∃a1:1->A b1:1->B. f = id(a1) & g = id(b1) & R[a:1->A,b:1->B](a1,b1)”)])) >>
 suffices_tac
 “?!cf:A->B. 
   ∀a:2->A b:2->B.
    (∃a1:1->A b1:1->B. a = id(a1) & b = id(b1) & R[a0:1->A,b0:1->B](a1,b1)) ⇔ 
   cf o a = b” 
 >-- (strip_tac >> 
...
(rpt strip_tac >> fs[Disc_def] >>
 ...
 >-- (strip_tac >>
     ...
     rfs[]) >>
 assume_tac
 (CC5_Disc_uex' |> qtinst_thm [(‘A’,‘T’),(‘B’,‘2’)]  
 |> qfVar_prpl_th1 ("R",[‘t':1->T’,‘b:1->2’],
...
(rpt strip_tac >>
 ...
 assume_tac
 (CC5_Disc_uex' |> qtinst_thm [(‘A’,‘D’),(‘B’,‘1+1’)] 
 |> qfVar_prpl_th1 ("R",[‘d:1->D’,‘b:1->1+1’],
...
(rpt strip_tac >>
 ...
 >-- (strip_tac >> pop_assum (strip_assume_tac o uex2ex_rule) >>
     qexists_tac ‘d0’ >> arw[]) >> 
 irule
 (CC5_Disc_uex' |> qtinst_thm [(‘A’,‘D’),(‘B’,‘Qs’)] 
 |> qfVar_prpl_th1 ("R",[‘od:1->D’,‘oqs:1->Qs’],
...
(rpt strip_tac >>
 ...
 >-- (strip_tac >> pop_assum (strip_assume_tac o uex2ex_rule) >>
     qexists_tac ‘i’ >> arw[]) >>
 irule
 (CC5_Disc_uex' |> qtinst_thm [(‘A’,‘D’),(‘B’,‘Dop’)] 
 |> qfVar_prpl_th1 ("R",[‘od:1->D’,‘odop:1->Dop’],
