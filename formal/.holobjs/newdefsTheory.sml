...
struct
  ...
  open Type Term Thm
  local open wffTheory in end;
  
  structure TDB = struct
    val thydata = 
      TheoryReader.load_thydata "newdefs"
        (holpathdb.subst_pathvars "/Users/yimingxu/Documents/GitHub/DSTPMFnewfV/formal/newdefsTheory.dat")
  ...
  fun op wffV_def _ = () val op wffV_def = TDB.find "wffV_def"
  ...
  fun op wffVmap_rn2fVmap _ = ()
  val op wffVmap_rn2fVmap = TDB.find "wffVmap_rn2fVmap"
  fun op fVars_EQ _ = () val op fVars_EQ = TDB.find "fVars_EQ"
  fun op wfvl_ffv _ = () val op wfvl_ffv = TDB.find "wfvl_ffv"
  fun op wffVmap_rn2fVmap1 _ = ()
  val op wffVmap_rn2fVmap1 = TDB.find "wffVmap_rn2fVmap1"
  fun op wff_wffV _ = () val op wff_wffV = TDB.find "wff_wffV"
  fun op wff_wffV' _ = () val op wff_wffV' = TDB.find "wff_wffV'"
  ...
  fun op SUBSET_one_Uof _ = ()
  val op SUBSET_one_Uof = TDB.find "SUBSET_one_Uof"
