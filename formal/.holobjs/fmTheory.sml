structure fmTheory :> fmTheory =
struct
  
  val _ = if !Globals.print_thy_loads
    then TextIO.print "Loading fmTheory ... "
    else ()
  ...
  structure TDB = struct
    val thydata = 
      TheoryReader.load_thydata "fm"
        (holpathdb.subst_pathvars "/Users/yimingxu/Documents/GitHub/DSTPMFnewfV/formal/fmTheory.dat")
...
val _ = Theory.load_complete "fm"

val fm_grammars = valOf (Parse.grammarDB {thyname = "fm"})
end
