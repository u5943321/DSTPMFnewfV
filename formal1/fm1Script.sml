...
open finite_setTheory tmTheory listTheory;
open finite_mapTheory;
open pred_setTheory;
val _ = new_theory "fm1";
...
Theorem substb_abst = frpl_fabs |> Q.SPECL [‘f’,‘0’] |> SRULE [GSYM substb_def,GSYM abst_def]                  
