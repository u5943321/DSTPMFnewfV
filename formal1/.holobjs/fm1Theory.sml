structure fm1Theory :> fm1Theory =
struct
  
  val _ = if !Globals.print_thy_loads
    then TextIO.print "Loading fm1Theory ... "
    else ()
  
  open Type Term Thm
  local open tmTheory in end;
  
  structure TDB = struct
    val thydata = 
      TheoryReader.load_thydata "fm1"
        (holpathdb.subst_pathvars "/Users/yimingxu/Documents/GitHub/DSTPMFnewfV/formal1/fm1Theory.dat")
  ...
  fun op substb_abst _ = () val op substb_abst = TDB.find "substb_abst"
  fun op finst_eq_cvmap1 _ = ()
  val op finst_eq_cvmap1 = TDB.find "finst_eq_cvmap1"
  ...
  fun op cstt_EXT1 _ = () val op cstt_EXT1 = TDB.find "cstt_EXT1"
...
val _ = Theory.load_complete "fm1"

val fm1_grammars = valOf (Parse.grammarDB {thyname = "fm1"})
end
